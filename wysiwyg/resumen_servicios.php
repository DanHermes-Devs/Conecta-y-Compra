...
<h3>Ingresa el resumen de tu tienda. Incluya aquí sólo los puntos clave del servicio o negocio.</h3>

<form method="post" id="formdata">

<input type="hidden" name="id_tienda" id="id_tienda" value="<?php echo $id_tienda;?>">

  <textarea id="summernote" name="resumendata">

	<?php echo $resumen_servicios;?>
  ...
  $('#summernote').summernote({
    ...
    $('#savedata').click(function(event){
		...
		var resumendata = $("#summernote").val();
		...
		if (resumendata.length < 5 )

	{

		$("#respuesta").html("<div class='errormsg'>Ingresa tu resumen.</div>");
        ...
        $.ajax({
            ...
            url : "/cyc/wysiwyg/save_resumen.php",

            type: "POST",

             data : "id_tienda="+tienda+"&resumendata="+content,
