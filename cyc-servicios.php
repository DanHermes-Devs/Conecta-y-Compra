...
.col-sm-4.col-md-4.buttoncont {
	margin-top: 20px;
}
</style>

    <!-- Page Content -->
    <div class="container pagecont" style="width: 100%; padding: 0 30px; ">

<h1 class="titlemain">CONECTA Y COMPRA SERVICIOS</h1>

			  <div class="row" >

		<div class="col-sm-12 col-md-12 " style="padding:0;     margin-bottom: 15px;">
		 <img class="imgcycs" src="img/banner1.jpg" style="width:100%;">
		 </div>

		 <div class="col-sm-12 col-md-12 fourprods" style="padding:0;">
			<div class="col-sm-3 col-md-3" >
			 <img class="imgcycs" src="img/banner2.jpg" style="width:100%;">
			 </div>
			 <div class="col-sm-3 col-md-3" >
			 <img class="imgcycs" src="img/banner3.jpg" style="width:100%;">
			 </div>
			 <div class="col-sm-3 col-md-3" >
			 <img class="imgcycs" src="img/banner4.jpg" style="width:100%;">
			 </div>
			 <div class="col-sm-3 col-md-3" >
			 <img class="imgcycs" src="img/banner5.jpg" style="width:100%;">
			 </div>
		 </div>

<div class="col-sm-8 col-md-8 bannercont" style="padding-left: 0px;
    padding-right: 0;">
...
margin-bottom: 10px;
	...
	<div class="btn btn-default redbutton" STYLE="background-color: #ed304c;
								...
								font-weight: 600;
							   margin-top: 10px;
								padding: 10px;"><a href="/cyc/registro.php">INVITADOS</a> | <a href="/cyc/registro.php">MIEMBROS</a> | <a href="/cyc/registro.php">EQUIPO</a></div>
