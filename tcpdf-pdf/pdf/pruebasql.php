...
$sql = "SELECT contratoServiciosCYC.*, usuarios.* 
FROM contratoServiciosCYC INNER JOIN usuarios on (contratoServiciosCYC.id_usuario=usuarios.id_usuario) WHERE usuarios.id_usuario = '" . $uid . "'";
$rs_result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($rs_result);

echo "<pre>";
print_r($row["fecha_nacimiento"]);
echo "</pre>";
